...
(text2 = function() {
	...
	// Layer 1
	//this.text = new createjs.Text("ID_s1_txt02", "11px 'Arial'");
    this.text = new getCJSElement("TEXT",{type:"TEXT",compId:"ID_s1_txt02",width:"120.4",expand:"down",align:"left", size:"12",color:"#393536"});
	this.text.lineHeight = 13;
	this.text.lineWidth = 142;
	this.text.setTransform(14.2,10,0.911,0.911,56.9);

	this.addChild(this.text);
}).prototype = p = new createjs.Container();
p.nominalBounds = new createjs.Rectangle(0,0,128.4,17);
...
(text1 = function() {
	...
	// Layer 1
	//this.text = new createjs.Text("ID_s1_txt01", "11px 'Arial'");
    this.text = new getCJSElement("TEXT",{type:"TEXT",compId:"ID_s1_txt01",width:"89.85",expand:"up",align:"right", size:"12",color:"#393536"});
	this.text.lineHeight = 13;
	this.text.lineWidth = 142;
	this.text.setTransform(42.5,31.05,0.911,0.911,56.9);

	this.addChild(this.text);
}).prototype = p = new createjs.Container();
p.nominalBounds = new createjs.Rectangle(0,0,94.1,17);


(Screwdriver02 = function() {
	this.initialize();
...
p.nominalBounds = new createjs.Rectangle(-1,-1,142.2,14.1);


(Screwdriver01 = function() {
	this.initialize();
...
p.nominalBounds = new createjs.Rectangle(-82.4,-7.2,156.5,15.4);


(FlatheadScrew02 = function() {
	this.initialize();
...
p.nominalBounds = new createjs.Rectangle(0,0,37.1,11.6);


(FlatheadScrew01 = function() {
	this.initialize();
...
p.nominalBounds = new createjs.Rectangle(-0.3,0,37.4,11.6);
...
p.nominalBounds = new createjs.Rectangle(-9,-6.6,19.2,17);


(ArrowCurved = function() {
	this.initialize();

	// Layer 2
	this.instance = new Arrowhead("synched",0);
...
p.nominalBounds = new createjs.Rectangle(-1.1,65.3,15.3,38.8);


(FlatheadScrewdriver = function(mode,startPosition,loop) {
	...
	// actions tween:
	this.timeline.addTween(createjs.Tween.get(this).wait(135).call(this.frame_135).wait(1));

	// text
	this.instance = new text1();
	this.instance.setTransform(5.7,-67.1,1,1,0,0,0,47.1,62.9);

	this.instance_1 = new text2();
	this.instance_1.setTransform(79,127.2,1,1,0,0,0,64.2,85.7);

	this.timeline.addTween(createjs.Tween.get({}).to({state:[{t:this.instance}]}).to({state:[{t:this.instance_1}]},45).to({state:[]},90).wait(1));

	// arrow
	this.instance_2 = new ArrowCurved();
	this.instance_2.setTransform(14.7,0.4,1.624,1.621,0,0,0,7.5,73.5);

	this.timeline.addTween(createjs.Tween.get(this.instance_2).wait(45).to({regX:7.4,regY:73.4,skewX:180,x:8.9,y:30.6},0).wait(91));

	// screwdriver
	this.instance_3 = new Screwdriver01();
	this.instance_3.setTransform(104.4,15.7,1.461,1.459);

	this.instance_4 = new Screwdriver02();
	this.instance_4.setTransform(91.8,16.2,1.624,1.621,0,0,0,70,6);
	this.instance_4._off = true;

	this.timeline.addTween(createjs.Tween.get(this.instance_3).to({_off:true},2).wait(2).to({_off:false,x:92.8},0).to({_off:true},2).wait(2).to({_off:false,x:81.3},0).to({_off:true},2).wait(2).to({_off:false,x:66,y:15.9},0).wait(33).to({_off:true},2).wait(2).to({_off:false,x:81.3,y:15.7},0).to({_off:true},2).wait(2).to({_off:false,x:92.8},0).to({_off:true},2).wait(2).to({_off:false,x:104.4},0).wait(79));
	this.timeline.addTween(createjs.Tween.get(this.instance_4).wait(2).to({_off:false},0).to({_off:true},2).wait(2).to({_off:false,regX:71.2,x:81.2,y:16.3},0).to({_off:true},2).wait(2).to({_off:false,x:68.2,y:16.1},0).to({_off:true},2).wait(35).to({_off:false},0).to({_off:true},2).wait(2).to({_off:false,x:81.2,y:16.3},0).to({_off:true},2).wait(2).to({_off:false,regX:70,x:91.8,y:16.2},0).to({_off:true},2).wait(79));

	// screw
	this.instance_5 = new FlatheadScrew01();
	this.instance_5.setTransform(-44.2,16.9,1.624,1.621,-1.3,0,0,18.6,5.9);

	this.instance_6 = new FlatheadScrew02();
	this.instance_6.setTransform(-49.4,16.8,1.624,1.621,0,0,0,18.6,5.9);
	this.instance_6._off = true;

	this.timeline.addTween(createjs.Tween.get(this.instance_5).to({_off:true},2).wait(2).to({_off:false,x:-56,y:17.2},0).to({_off:true},2).wait(2).to({_off:false,rotation:0,x:-67.7,y:16.3},0).to({_off:true},2).wait(2).to({_off:false,regX:18.5,x:-83.3,y:16.5},0).wait(33).to({_off:true},2).wait(2).to({_off:false,regX:18.6,x:-67.7,y:16.3},0).to({_off:true},2).wait(2).to({_off:false,rotation:-1.3,x:-56,y:17.2},0).to({_off:true},2).wait(2).to({_off:false,x:-44.2,y:16.9},0).wait(79));
	this.timeline.addTween(createjs.Tween.get(this.instance_6).wait(2).to({_off:false},0).to({_off:true},2).wait(2).to({_off:false,x:-61.6,y:16.6},0).to({_off:true},2).wait(2).to({_off:false,regY:5.8,x:-74.5,y:16.3},0).to({_off:true},2).wait(35).to({_off:false},0).to({_off:true},2).wait(2).to({_off:false,regY:5.9,x:-61.6,y:16.6},0).to({_off:true},2).wait(2).to({_off:false,x:-49.4,y:16.8},0).to({_off:true},2).wait(79));

}).prototype = p = new createjs.MovieClip();
p.nominalBounds = new createjs.Rectangle(-75,-130,286.9,179.9);


(ScrewdriverAnimation = function() {
	this.initialize();
	...
	// Layer 3
	this.instance = new FlatheadScrewdriver();
	this.instance.setTransform(153.9,142.6,0.998,0.998,-56.9,0,0,68,-16.1);
...
p.nominalBounds = new createjs.Rectangle(0,0,360,320);
...
(slide_1 = function() {
	...
	// Layer 1
	this.instance = new ScrewdriverAnimation();
	this.instance.setTransform(410,341.6,1,1,0,0,0,250,256.6);
	this.instance.shadow = new createjs.Shadow("rgba(0,0,0,1)",0,0,5);

	this.addChild(this.instance);
}).prototype = p = new createjs.Container();
p.nominalBounds = new createjs.Rectangle(155,81,374,332);
...
p.nominalBounds = new createjs.Rectangle(495,326,374,332);
        var main = new FlatheadScrewdriver();
        main.x=280
		main.y = 280
        main.scaleX=1
        main.scaleY=1
		main.rotation = -56.8659;
        _container.addChild(main);
        update = true;
    }
    if(_id==5){
        var currentKnobSelected = 0;
        var previousClickedId = 0;
        var incrementKnob = 0;
        buttonArr=[];
        buttonOverArr=[];
        mainImageArr = [];
        bubbleArr=[];
        btnXPosArr=[180.15, 178.35, 198.2, 218, 238, 202, 236, 187];
        btnYPosArr=[170.5, 213.5, 213.5, 213.5, 213.5, 315.25, 315.05, 241];   
        btnWidthArr = [76,17.8,17.8,17.8,17.8,24.55,18.55,60];
        btnHeightArr = [35,11.9,11.9,11.9,11.9,43.35,41.3,60];
        btnImageArr = ["button1.png","button2.png","button3.png","button4.png","button5.png","button7.png","button8.png","button6.png"];
        btnImageOverArr = ["button1_over.png","button2_over.png","button3_over.png","button4_over.png","button5_over.png","button7_over.png","button8_over.png","button6_over.png"];
        imagesArray = ["media_2.2.4.3_s5_1.png", "media_2.2.4.3_s5_2.png", "media_2.2.4.3_s5_3.png", "media_2.2.4.3_s5_4.png", "media_2.2.4.3_s5_5.png", "media_2.2.4.3_s5_6.png", "media_2.2.4.3_s5_7.png"];
        bubbleTitleArr=["ID_s5_titleTxt", "ID_s5_titleTxt01","ID_s5_titleTxt02","ID_s5_titleTxt03","ID_s5_titleTxt04","ID_s5_titleTxt05","ID_s5_titleTxt06","ID_s5_titleTxt07","ID_s5_titleTxt08","ID_s5_titleTxt09","ID_s5_titleTxt10","ID_s5_titleTxt11","ID_s5_titleTxt12","ID_s5_titleTxt13","ID_s5_titleTxt14"];
        bubbleTextArr=["ID_s5_bodyTxt", "ID_s5_bodyTxt01","ID_s5_bodyTxt02","ID_s5_bodyTxt03","ID_s5_bodyTxt04","ID_s5_bodyTxt05","ID_s5_bodyTxt06","ID_s5_bodyTxt07","ID_s5_bodyTxt08","ID_s5_bodyTxt09","ID_s5_bodyTxt10","ID_s5_bodyTxt11","ID_s5_bodyTxt12","ID_s5_bodyTxt13","ID_s5_bodyTxt14"];
        ...
        for(var j = 0; j < imagesArray.length; j++) {
            ...
            mainImages = getCJSElement("IMAGE",{x:0,y:0,width:680,height:490,src:imagesArray[j]});
            mainImageArr.push(mainImages);
            container.addChild(mainImages);
            
            if(j != 0) mainImages.visible = false;
        }
        
        for(var i = 0; i < btnImageArr.length; i++) {
            
            //$('#image'+(i+1)).css('display', 'none');
            var container1=new createjs.Container();
            _container.addChild(container1);
            container1.id=(i+1);
            container1.cursor="pointer";
            
            btn = getCJSElement("IMAGE",{x:btnXPosArr[i],y:btnYPosArr[i],width:btnWidthArr[i],height:btnHeightArr[i],src:btnImageArr[i]});
            
           
            buttonArr.push(btn);
            container1.addChild(btn);
            
            btn1 = getCJSElement("IMAGE",{x:btnXPosArr[i],y:btnYPosArr[i],width:btnWidthArr[i],height:btnHeightArr[i],src:btnImageOverArr[i]});
            buttonOverArr.push(btn1);
            container1.addChild(btn1);
            btn1.visible = false;
            
            /*var btn2 = getCJSElement("TEXTBOX",{x:428,y:90,width:230,height:245,size:11,titleId:bubbleTitleArr[i],bodyId:bubbleTextArr[i]});
        ...
        for(var k = 0; k < bubbleTitleArr.length; k++) {
             var container2 = new createjs.Container();
            _container.addChild(container2);
            container2.id = (k+1);
            
            var btn2 = getCJSElement("TEXTBOX",{x:315,y:85,width:250,height:303,size:11,titleId:bubbleTitleArr[k],bodyId:bubbleTextArr[k]});
            _container.addChild(btn2);

            bubbleArr[k]=btn2;
            if(k != 0) bubbleArr[k].visible=false;
        }
    }
    ...
    function handlerMethod(event) {
        ...
        for(var j = 0; j < btnImageOverArr.length; j++) {
            buttonOverArr[j].visible = false;
        }
        
        for(var k = 0; k < mainImageArr.length; k++) {
            mainImageArr[k].visible = false;
        }
        
        buttonOverArr[event.target.id-1].visible = true;
       
        if(event.target.id != 8 ) {
            bubbleArr[event.target.id].visible = true;
            mainImageArr[incrementKnob].visible = true;
        } else {
            var lookupArrayIndex = currentKnobSelected+event.target.id;
            mainImageArr[currentKnobSelected].visible = true;
            bubbleArr[lookupArrayIndex].visible = true;
            incrementKnob = currentKnobSelected;
            if(currentKnobSelected == 6) {
                currentKnobSelected = 0;
            } else {
                currentKnobSelected++;
            }
        }
        previousClickedId = event.target.id;
    }
})
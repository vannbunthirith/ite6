...
//accessbility fix
   var label = new ButtonLabelComp({ x: 1, y: 0, width: 40, height: 40, compId: "text_id_0" + (1), align: "center", color: "#343434", bold: "obj.bold", style: "pointer-events:all;cursor:pointer;" + "line-height:" + "1.1" });
   
   $("#text_id_01").attr("name","moreInfo");
   btn.addChild(label);

 	$("#text_id_01").insertBefore("#ID_txt01");

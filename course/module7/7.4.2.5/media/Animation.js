(function(lib, img, cjs) {
    ...
    (lib.ID_txt07 = function() {
        ...
        // ID_txt07
        this.text = new getCJSElement("TEXT", { align: "center", compId: "ID_txt07", size: "10", width: "130", expand: "up", class: "orangeCallOut" });
    ...
    (lib.ID_txt06 = function() {
        ...
        // ID_txt06
        this.text = new getCJSElement("TEXT", { align: "center", compId: "ID_txt06", size: "10", width: "146", expand: "up", class: "orangeCallOut" });
        this.addChild(this.text);
    }).prototype = p = new cjs.Container();
    ...
    (lib.ID_txt05 = function() {
        ...
        // ID_txt05
        this.text = new getCJSElement("TEXT", { align: "left", compId: "ID_txt05", width: "103.8", expand: "down" });
        this.addChild(this.text);
    }).prototype = p = new cjs.Container();
    ...
    (lib.ID_txt04 = function() {
        ...
        // ID_txt04
        this.text = new getCJSElement("TEXT", { align: "left", compId: "ID_txt04", width: "55.7", expand: "down" });
        this.addChild(this.text);
    }).prototype = p = new cjs.Container();
    ...
    (lib.ID_txt03 = function() {
        ...
        // ID_txt03
        this.text = new getCJSElement("TEXT", { align: "center", compId: "ID_txt03", width: "54.45", expand: "up+down" });
    ...
    (lib.ID_txt02 = function() {
        ...
        // ID_txt02
        this.text = new getCJSElement("TEXT", { align: "center", compId: "ID_txt02", width: "48.6", expand: "up+down" });
        this.addChild(this.text);
    }).prototype = p = new cjs.Container();
    p.nominalBounds = new cjs.Rectangle(0, 0, 107, 16.2);
    ...
    (lib.ID_txt01 = function() {
        ...
        // ID_txt01
        this.text = new getCJSElement("TEXT", { align: "center", compId: "ID_txt01", width: "85", expand: "up+down" });
        this.addChild(this.text);
    }).prototype = p = new cjs.Container();
    p.nominalBounds = new cjs.Rectangle(0, 0, 107, 16.2);
